...
function bundle(key: string, label: string, screens: ScreenDef[]): BundleDef {
  return { key, label, screens };
}

// A module with too few screens to need grouping gets one unlabeled
// bundle — the sidebar skips the bundle header entirely when there's
// only one (see Sidebar.tsx / MoreMenuScreen.tsx).
function single(screens: ScreenDef[]): BundleDef[] {
  return [{ key: "_single", label: "", screens }];
}

// Full screen inventory per docs/screens.md, grouped into named bundles so
// no module's sidebar entry is a 10+ item flat list. Notifications,
// Integrations, and Administration are folded into Settings as bundles
// rather than standalone sidebar modules; "Stock Operations" is merged
// into Inventory (docs/screens.md always treated it as part of the
// 13-screen Inventory section).
export const MODULE_TREE: ModuleDef[] = [
  ...
  },
  {
    ...
    bundles: [
      ...
      bundle("PricingAndCodes", "Pricing & Codes", [
  ...
  },
  {
    ...
    bundles: [
      bundle("Overview", "Stock Overview", [
      ...
      bundle("Operations", "Stock Operations", [
      ...
      bundle("CountsAndExceptions", "Counts & Exceptions", [
      ...
      bundle("ValuationAndSettings", "Valuation & Settings", [
  ...
  },
  {
    ...
    bundles: [
      ...
      bundle("BillingAndReturns", "Billing & Returns", [
  ...
  },
  {
    ...
    bundles: [
      ...
      bundle("SalesRecords", "Sales Records", [
      ...
      bundle("Documents", "Sales Documents", [
      ...
      bundle("PaymentsAndCredit", "Payments & Credit", [
      ...
      bundle("ReturnsAndDiscounts", "Returns & Discounts", [
      ...
      bundle("ReportingAndSettings", "Reporting & Settings", [
  ...
  },
  {
    ...
    bundles: [
      ...
      bundle("CreditAndHistory", "Credit & History", [
  ...
  },
  {
    ...
    bundles: [
      ...
      bundle("CashHandling", "Cash Handling", [
  ...
  },
  {
    ...
    bundles: [
      ...
      bundle("MaterialsAndReporting", "Materials & Reporting", [
  ...
  },
  {
    ...
    bundles: [
      bundle("MyApprovals", "My Approvals", [
  ...
  },
  {
    ...
    bundles: [
      ...
      bundle("SalesAndProfit", "Sales & Profit", [
      ...
      bundle("OperationsAndExport", "Operations & Export", [
  ...
  },
  {
    ...
    bundles: [
      ...
      bundle("AccessAndSecurity", "Access & Security", [
      ...
      bundle("Administration", "Administration", [
...
export function allScreens(module: ModuleDef): ScreenDef[] {
  return module.bundles.flatMap((b) => b.screens);
}

export function findScreen(
  screenKey: string
): { module: ModuleDef; bundle: BundleDef; screen: ScreenDef } | undefined {
  for (const module of MODULE_TREE) {
    for (const b of module.bundles) {
      const found = b.screens.find((s) => s.key === screenKey);
      if (found) return { module, bundle: b, screen: found };
    }
  }
  return undefined;
}
...
export function defaultScreenFor(moduleKey: string): ScreenDef | undefined {
  ...
  return module?.bundles[0]?.screens[0];
}
