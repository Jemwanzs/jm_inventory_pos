← [README](../README.md) · [Core Modules](modules.md) · [Database](database.md) · [Backend Architecture](backend-architecture.md) · [UI/UX](ui-ux.md) · [Screens](screens.md) · [Roadmap](roadmap.md) · [Deployment](deployment.md)
